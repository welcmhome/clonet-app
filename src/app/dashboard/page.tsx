      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', height: 64, marginLeft: 20 }}>
          ...
          <span style={{ display: 'flex', alignItems: 'baseline' }}>
            <span style={{ fontFamily: '"Pixelify Sans", monospace', fontWeight: 400, fontSize: 22, letterSpacing: '0.01em', lineHeight: 1.1, color: '#222', whiteSpace: 'nowrap', marginLeft: 2, opacity: 1, transition: 'opacity 0.2s', overflow: 'hidden', textOverflow: 'ellipsis', flexShrink: 0 }}>
              clonet
            </span>
            <span style={{
